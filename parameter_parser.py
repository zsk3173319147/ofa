...
def parameter_parser():
    ...
    parser.add_argument('--tricl_seed_mode', default='mixed', choices=['node', 'edge', 'mixed'])
    ...
    parser.add_argument('--tricl_tau_node', default=0.5, type=float)
    parser.add_argument('--tricl_tau_group', default=0.5, type=float)
    parser.add_argument('--tricl_tau_membership', default=1.0, type=float)
    parser.add_argument('--tricl_weight_group', default=1.0, type=float)
    parser.add_argument('--tricl_weight_membership', default=1.0, type=float)
    parser.add_argument('--tricl_proj_dim', default=128, type=int)
    parser.add_argument('--tricl_proj_dropout', default=0.0, type=float)
    parser.add_argument('--tricl_max_contrast_items', default=2048, type=int)
