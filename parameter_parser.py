...
def parameter_parser():
    ...
    parser.add_argument('--downstream_mode', default='finetune', choices=['finetune','encoder_finetune','linear_probe','zero_shot','unified'])
    parser.add_argument('--unified_head_type', default='auto', choices=['auto','linear','mlp'])
    parser.add_argument('--unified_readout', default='object', choices=['object','task_hypergraph','prompt_hypergraph'])
    parser.add_argument('--task_reason_layers', default=1, type=int)
    parser.add_argument('--task_reason_dropout', default=0.0, type=float)
    parser.add_argument('--task_context_hops', default=1, type=int)
    parser.add_argument('--task_max_node_context', default=32, type=int)
    parser.add_argument('--task_max_hyperedge_context', default=16, type=int)
    parser.add_argument('--prompt_readout_dropout', default=0.0, type=float)
    parser.add_argument('--prompt_residual_init', default=-5.0, type=float)
    parser.add_argument('--unified_node_batch_size', default=None, type=int)
    parser.add_argument('--subgraph_mode', default='full', choices=['full','propagation'])
